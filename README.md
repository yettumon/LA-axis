...
**소속**: 독립 연구자 | Jeju City, Jeju-do, KR  
...
| 논문 | DOI |
|------|-----|
| TRT (Tilted Ruler Theory) | https://doi.org/10.5281/zenodo.20572073 |
| LA-axis (본 논문) | 준비 중 |
| GCOD (Grand Celestial Orbital Dynamics) | 준비 중 |
...
```
Kim, G. S. (2026). LA-axis: Leo-Aquarius Axis Anisotropy Analysis.
GitHub: https://github.com/yettumon/LA-axis
Zenodo DOI: 준비 중
```
